    ...
    const arrivalData = useMemo(() => {
        ...
        for (let i = 0; i < days; i++) {
            ...
            data.push({
                ...
                predicted: Math.floor(Math.random() * 55) + 25
            });
        }
            ...
            <div className="component-ui-arrival-room-graph-header">
                ...
                <div className="component-ui-arrival-room-graph-toggle">
                    {(['1w', '1m', '3m', '6m', '12m'] as const).map(period => (
                        <button
                            key={period}
                            className={`component-ui-arrival-room-graph-toggle-btn ${timePeriod === period ? 'active' : ''}`}
            ...
            <ResponsiveContainer width="100%" height={300}>
                ...
                >
                    ...
                    <XAxis
                        ...
                        interval={Math.floor(arrivalData.length / 8)}
                    />
